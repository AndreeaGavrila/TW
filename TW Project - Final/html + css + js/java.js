    ...
    if(( nameErr || emailErr || mobileErr || tipulprodErr || livrareErr || plataErr) == true) {
       return false; }
        ...
        var dataPreview = "Ati introdus urmatoarele date: \n\n" +
                          ...
                          "Descrierea produsului: " + descriereprod + "\n" +
                          "Livrare: " + livrare + "\n" +
                          "Adresa: " + adresa + "\n" +
